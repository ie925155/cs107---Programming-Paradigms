...
inline const char *determinePathToData(const char *userSelectedPath = NULL)
{
  ...
  return NULL;
  #endif
  //return "/Users/glay_luncy/Workspace/cs107/Programming_Assignments/assn-2-six-degrees-data/little-endian";
  //return "/Users/glay_luncy/Workspace/cs107/Programming_Assignments/assn-2-six-degrees-data/little-endian";
  return "/mnt/hgfs/glay_luncy/Dropbox/cs107/Programming_Assignments/assn-2-six-degrees-data/little-endian";
}
